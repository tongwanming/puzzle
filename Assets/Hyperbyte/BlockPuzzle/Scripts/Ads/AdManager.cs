...
namespace Hyperbyte.BlockPuzzle.Scripts.Ads
{
    public class AdManager : Singleton<AdManager>
    {
        ...
        public void OnInterstitialClosed() { if (OnInterstitialClosedEvent != null) { OnInterstitialClosedEvent.Invoke(); } }
        ...
        {
            LogUtils.Log("unity-script: I got RewardedVideoAdRewardedEvent, amount = " + ssp.getRewardAmount() + " name = " + ssp.getRewardName());
            OnRewardedAdRewarded();
        }
        ...
        {
            LogUtils.Log("unity-script: I got InterstitialAdLoadFailedEvent, code: " + error.getCode() + ", description : " + error.getDescription());
        ...
        {
            LogUtils.Log("unity-script: I got InterstitialAdShowFailedEvent, code :  " + error.getCode() + ", description : " + error.getDescription());
        }
        ...
        {
            LogUtils.Log("unity-script: I got BannerAdLoadFailedEvent, code: " + error.getCode() + ", description : " + error.getDescription());

...
namespace Hyperbyte
{
    public class GameOver : MonoBehaviour
    {
        ...
        string doubleRewardVideoTag = "DoubleReward";
        ...
        {   
            ...
            // ProfileManager.Instance.SetAllScore(ProfileManager.Instance.GetAllScore(gameMode) + score, gameMode);
            ProgressGameReward();
        ...
        /// 看激励视频领双倍奖励
        /// </summary>
        public void OnDoubleRewardWatchVideo()
        {
            if (AdManager.Instance.IsRewardedAvailable()) {
                AdManager.Instance.ShowRewardedWithTag(doubleRewardVideoTag);
            }
            else
            {
        ...
        {
            if (watchVidoTag == doubleRewardVideoTag)
            {
                ShowRewardAnimation();
            }
        }

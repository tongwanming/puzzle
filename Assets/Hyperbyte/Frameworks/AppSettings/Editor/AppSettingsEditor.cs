	...
	public class AppSettingsEditor : CustomInspectorHelper 
	{
		...
		void DrawCommonSettings() 
		{
			...
			if(isExpanded) {
				...
				EditorGUILayout.Space();
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Terms & Conditions : ",  labelStyle,GUILayout.MaxWidth(140));
				appSettings.termsConditionsURL = EditorGUILayout.TextField(appSettings.termsConditionsURL);
				EditorGUILayout.EndHorizontal();
